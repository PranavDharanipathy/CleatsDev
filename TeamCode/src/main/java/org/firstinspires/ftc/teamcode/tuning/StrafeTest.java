...
public class StrafeTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("The robot will strafe right. Cruise until it says A, then press A to begin braking.");
        telemetry.update();
        ...
        while (opModeIsActive() && !gamepad1.a) {
            ...
            pc.getChassis().setDrivePowerBypassRamp(0, 1, 0);
        ...
        telemetry.addData("amaxS (in/s^2)", fit[1]);
        telemetry.addData("dmaxS (in/s^2)", distance > 0 ? vmax * vmax / (2 * distance) : 0);
        telemetry.addData("vmaxS (in/s)", vmax);
        telemetry.update();
